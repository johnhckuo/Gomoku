...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scss_reset_scss__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scss_reset_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__scss_reset_scss__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__canvas_render_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__div_render_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_sweetalert2__ = __webpack_require__(7);
...
function fetchBrowserInfo(){
    ...
    if (__WEBPACK_IMPORTED_MODULE_2__canvas_render_js__["a" /* default */].isCanvasSupported()){
			if (!$('#main').length){
				$("body").append("<canvas id='main'></canvas>");
			}
			canvas = document.getElementById('main');
      ctx = canvas.getContext('2d');
			__WEBPACK_IMPORTED_MODULE_2__canvas_render_js__["a" /* default */].setWindowBoundary(ctx, width, height);
      canvas_support = true;
    }else{
			if (!$('#container').length){
...
function drawArc(xPos, yPos, radius, startAngle, endAngle, anticlockwise, lineColor, fillColor){
		if (canvas_support){
			__WEBPACK_IMPORTED_MODULE_2__canvas_render_js__["a" /* default */].drawArc(xPos, yPos, radius, startAngle, endAngle, anticlockwise, lineColor, fillColor);
		}else{
			__WEBPACK_IMPORTED_MODULE_3__div_render_js__["a" /* default */].drawArc(xPos, yPos, radius, startAngle, endAngle, anticlockwise, lineColor, fillColor);
		}
}

function renderChessBoard(){
		if (canvas_support){
	    __WEBPACK_IMPORTED_MODULE_2__canvas_render_js__["a" /* default */].init(horizontal_segment, horizon_interval, vertical_segment, vertical_interval);
	    __WEBPACK_IMPORTED_MODULE_2__canvas_render_js__["a" /* default */].renderChessBoard();
		}else{
			__WEBPACK_IMPORTED_MODULE_3__div_render_js__["a" /* default */].init(horizontal_segment, horizon_interval, vertical_segment, vertical_interval);
			__WEBPACK_IMPORTED_MODULE_3__div_render_js__["a" /* default */].renderChessBoard();
		}
}
...
function rerenderCanvas(){
	  fetchBrowserInfo();
		if (canvas_support){
			__WEBPACK_IMPORTED_MODULE_2__canvas_render_js__["a" /* default */].clearCanvas(canvas.width, canvas.height);
		}else{
			__WEBPACK_IMPORTED_MODULE_3__div_render_js__["a" /* default */].resetContainer();
		}
		renderChessBoard();
}
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {var Div = {
